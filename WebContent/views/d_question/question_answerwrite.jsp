...
<div>
            ...
            <div id="rightcontent">
                <div id="content_title">
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small style='background-color:#DAD9FF; '><b>${dto.getMyname() }</b>님 안녕하세요😊 </small>
                    <h1>Q&amp;A</h1>
                    <h4>[찾아주개냥] - Q&amp;A ${parent.question_name }님의 글에 답변글을 작성하세요.</h4>
                    <hr width="890">
                </div>
	...
	<!--  <h1>답변 글 작성</h1> -->
	<form action="<%=request.getContextPath() %>/question.do" method="post" id="insertform">
		<input type="hidden" name="command" value="question_answerwrite">
		<input type="hidden" name="question_parentboardno" value="${parent.question_boardno}">
		...
		<table border="1" class="tableone">
			...
			<tr>
				...
				<td><input size="30" type="text" name="title" value="↳RE:${parent.question_title}"></td>
			</tr>
			<tr>
				<th>내용</th>
			...
			<tr>
				...
				<input type="button" value="취소" onclick="location.href='<%=request.getContextPath()%>/question.do?command=question_detail&question_boardno=${parent.question_boardno }'"
