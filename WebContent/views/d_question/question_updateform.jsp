...
<div>
            ...
            <div id="rightcontent">
                <div id="content_title">
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small style='background-color:#DAD9FF; '><b>${dto.getMyname() }</b>님 안녕하세요😊 </small>
                    <h1>Q&amp;A</h1>
                    <h4>[찾아주개냥] - ${dto2.question_name }님의 글 수정 </h4>
                    <hr width="890">
                </div>
	...
	<!--  <h1>글 수정</h1>-->
	<form action="<%=request.getContextPath()%>/question.do" method="post">
	<input type="hidden" name="command" value="question_updateform">
	<input type="hidden" name="question_boardno" value="${dto2.question_boardno }">
	...
	<table border="1" class="tableone">
		...
		<tr>
			<th>제목</th>
			<td><input type="text" name="title" value="${dto2.question_title}"></td>
		</tr>
		<tr>
			<th>내용</th>
			<td><textarea rows="40" cols="100" name="content" id="content">${dto2.question_content }</textarea></td>
		</tr>
		<tr>
			<td colspan="2" align="right">
				<input type="submit" value="수정" style="background-color:#D9E5FF; border-radius : 5px; ">
				<input type="button" value="취소"
					onclick="location.href='<%=request.getContextPath()%>/question.do?command=question_detail&question_boardno=${dto2.question_boardno}'"
