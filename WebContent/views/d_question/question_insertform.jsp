...
<div>
	...
	<input type="hidden" name="command" value="question_insert">
	<input type="hidden" name="myid" value="${dto.getMyid() }">
		...
		<table border="1" class="tableone">
			...
			<tr>
				<th>제목</th>
				<td><input type="text" name="title" value="[Q&A]질문합니다."> </td>
			</tr>
			<tr>
				<th>내용</th>
			...
			<tr>
				<td colspan="3" align="right">
					...
					<input type="button" value="취소" onclick="location.href='<%= request.getContextPath() %>/question.do?command=question_listboard'"
