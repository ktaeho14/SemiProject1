...
<html>
<head>
<meta charset="UTF-8"><!-- 목격/보호 에서 목격한 위치 찍을 때 사용, 실행시 element보면서 하면 이해가 쉬울 것 같습니다! -->
    ...
    <section>
        ...
        <div class="content_layout">
            ...
            <div id="rightcontent">
                ...
                <div id="maincontent">
<h3>▶목격- ${map.map_no }번글 수정하기</h3>

<form action="<%=request.getContextPath() %>/map.do" method="post">
	<input type="hidden" name="command" value="map_update">
	<input type="hidden" name="map_no" value=${map.map_no} >
                    ...
                    <table border="1" class="tableone">
                    	<tr>
                    		...
                    		-위도,경도 : &nbsp; <input type="text" id="pick_result" style="width:200px;" value="${map.latitude },${map.longtitude}">
							-주소 : &nbsp;<input type="text" id="pick_result_address" style="width:200px;" value="${map.land_number_address}/${map.road_name_address}"></td>
                    	</tr>
                    	<tr>
                    		<th>폰번호</th>
                    	...
                    	<tr>
                    		<th>작성자</th>
                    		<td><input type="text" name="writer" value="${dto.myid }(${dto.myname })님" readonly="readonly"  style="border:0;"
                    		placeholder="
                     이곳은 자세히 기억 안 나지만 목격을 하신분들이 적어주시는 곳입니다. 
                    작은 정보라도 반려동물의 주인에게는 큰 도움이 됩니다. 
                    자세하게 아시는 분은 [목격/보호] 게시판을 이용 부탁드립니다." ></td>
							
                    	</tr>
               			
                    	<tr>
                    		<th>글 작성</th>
                    		<td><textarea cols="100" rows="20" name="content"   style="border:0;" id="specialmark" 
                    		value="${map.map_content }"
                    		required="required" onclick="check();"></textarea></td>
                    	</tr>
                    	<tr>
                    		<td colspan="2" align="right"><input type="submit" value="작성완료" style="background-color:#D9E5FF; border-radius : 5px; ">
                    		    <input type="button" value="목록" onclick='window.history.back();' style="background-color:#D9E5FF; border-radius : 5px; "></td>
                    	</tr>
