    ...
    <section>
        ...
        <div class="content_layout">
            ...
            <div id="rightcontent">
                ...
                <div id="maincontent">
                    <form
                        action="<%=request.getContextPath() %>/review.do?command=registerLostReviewArticle&num=${toRegisterLostReview.num}"
                        ...
                        <table border="1">
                            <tbody>
                                ...
                                <tr>
                                    <th>잃어버린 날짜</th>
                                    <td><input type="text" name="lostDate" value="${toRegisterLostReview.lostDate}"
                                            required readonly></td>
                                </tr>
                                <tr>
                                    <th>잃어버린 장소</th>
                                    <td>
                                        <label for="province">도/특별시/광역시:<input type="text" name="province"
                                                value="${toRegisterLostReview.province }" readonly></label><br />
                                        <label for="reserveAddr">나머지 주소&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</label>
                                        <input type="text" name="reserveAddr" id="reserveAddr"
                                            value="${toRegisterLostReview.reserv }" required readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <th>종류</th>
                                    <td>
                                        ...
                                        <input type="text" name="cate" value="${toRegisterLostReview.cate}" required
                                            readonly>
