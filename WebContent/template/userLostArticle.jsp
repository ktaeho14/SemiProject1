                    ...
                    <form action="lost.do" method="get">
                        <div class="contents">
                            ...
                            <div class="register">
                                ...
                                <input type="button" value="내가 등록한 글" id="my-lost-article" title="내가 찾은 아이 후기 등록하기"
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="list" items="${userLostArticle}">
                                            <div class="item"
                                                onclick="location.href='<%=request.getContextPath() %>/review.do?command=registerReview&num=${list.num}';">
                                    ...
                                    <c:when test="${pageNum !=0}">
                                        <c:forEach var="page" begin="1" end="${pageNum}">
                                            <input type="button" value="${page}"
                                                onclick="location.href='<%=request.getContextPath() %>/lost.do?command=showLostMine&writer=${writer}&page=${page}';">
                                        </c:forEach>
                                    </c:when>
                                </c:choose>
                            </div>
